        ...
        <div class="pay-form-bx">
          <form action="./PaytmKit/pgRedirect.php" method="POST">
               <div class="form-group p-3">
                 <label class="text-white" for="order_id" >Donar Id</label>
                 <input id="ORDER_ID" tabindex="1" maxlength="20" size="20" class="form-control"
						      name="ORDER_ID" autocomplete="off"
						      value="<?php echo  "ORDS" . rand(10000,99999999)?>">
               </div>
               <div class="form-group p-3">
                 <label class="text-white" for="cust_id">Email</label>
                 <input id="CUST_ID" class="form-control" tabindex="2" maxlength="12" size="12" name="CUST_ID" autocomplete="off" value="<?php echo $_REQUEST['email']; ?>">
                </div>
                <div class="form-group p-3">
